...
<div id="primary">
	...
	<div class="post">
		...
		<?php if( have_books(intval($nr_id)) ) : ?>
			...
			<p>
				<a target="_blank" href="<?php book_url() ?>"><img src="<?php book_image() ?>" alt="<?php book_title() ?>" /></a>
			</p>

			<?php if( !is_custom_book() ): ?>
				<p>You can view this book's Amazon detail page <a href="<?php book_url() ?>">here</a>.</p>
			<?php elseif( book_meta("PublisherUrl", false) ): ?>
				<p>You can view this book's detail page <a target="_blank" href="<?php book_url() ?>">here</a>.</p>
			<?php endif; ?>

			<?php if( book_has_post() ): ?>
				<p>This book is linked with the post <a target="_blank" href="<?php book_post_url() ?>">&ldquo;<?php book_post_title() ?>&rdquo;</a>.</p>
			<?php endif; ?>
